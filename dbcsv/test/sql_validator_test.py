...
tests = [
   ...
   ("SELECT id + age FROM table1",           False, SyntaxError),
    ...
    ("SELECT * FROM table1",                            True,  None),
    ("SELECT id FROM table1",                           True,  None),
    ("SELECT table1.* FROM table1",                     True,  None),
    ("SELECT db1.table1.* FROM table1",                 True,  None),
    ("SELECT table1.id FROM table1",                    True,  None),
    ("SELECT db1.table1.id FROM table1",                True,  None),
    ("SELECT *, id, table1.age, db1.table1.name FROM table1", True, None),
...
if __name__ == "__main__":
    ...
    for test in tests:
        ...
        try:
            ...
            validator.validate(tree, 'db1')
            print(f"Test passed for SQL: {sql}")
